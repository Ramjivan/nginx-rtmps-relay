...
docker run -dti -p 1935:1935 --name test -e PORT=1935 -e STREAMS="rtmp://gopal.streamway.in/live/1474" -e DENY_PULL=True -e LOCAL_STREAM=6WcGk8BgPj6BzyQIn6xa1  swtest 
